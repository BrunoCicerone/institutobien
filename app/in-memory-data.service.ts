...
export class InMemoryDataService implements InMemoryDbService {
  createDb() {
    const usuariosDb = [
      ...
      {id: 4, dni:'7866984R', nom:'Zaira', ap:'Lopez Sempere', us: 'zls', pas:'1234', f:'img', dir:'C. de las lomas blancas', tel:634983216,t_us:'1',ac:true },
      {id: 7, dni:'9158972E', nom:'Emma', ap:'Requena Lopez', us: 'erl', pas:'1234', f:'img', dir:'Plaza la viña', tel:695866216,t_us:'1',ac:true }
    ];
    return {usuariosDb};
  }
